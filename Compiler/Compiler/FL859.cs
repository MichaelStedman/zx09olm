...
namespace Compiler
{
   public class FL859 : UvBase
   {
      ...
      readonly UvVar MCODE_DESCRIPTION = 1;
      #endregion
      #region String Constants
      readonly UvVar INIT = "";
      #endregion
      #region Arrays
      UvVar[] MCODE_REC = new UvVar[5];
      #endregion
      #region Variables
      UvVar MARKETING_ID = "";
      UvVar INTERACT = "";
      ...
      UvVar nrf1 = "";
      #endregion
      public FL859(ref UvVar MARKETING_ID, ref UvVar INTERACT, ref UvVar REDISPLAY)
      {
         ...
         #endregion
         /*     MARKETING CODE LIST / SELECTION SCREEN */
         PROGRAM = "FL859";
         ...
         #region INCLUDE FL.FILES FL.MARKETING.CODES
         if (!OPEN("FL.MARKETING.CODES", out FL_MARKETING_CODES)) { STOP("201", "FL.MARKETING.CODES"); }
         ...
         INSTRUCTION = "SSELECT FL.MARKETING.CODES BY 1";
         nrf0 = "SO";
      ...
      void L1000()
      {
         ...
         do
         {
            ...
            {
               MARKETING_ID = MARKETING_LIST[1, WAIT];
               if (MARKETING_ID == "")
               {
                  nrf0 = 1;
                  nrf1 = INIT;
      ...
      void L3000()
      {
         ...
         do
         {
            ...
            {
               CNT = CNT + 1;
               MARKETING_ID = MARKETING_LIST[1, MARKETING_NO];
               ...
               {
                  if (!MATREAD(ref MCODE_REC, FL_MARKETING_CODES, MARKETING_ID)) { MAT(ref MCODE_REC, ""); }
                  DISPLAY_LINE = FORMAT(MARKETING_NO, "R#4") + "  " + FORMAT(MARKETING_ID, "L#7") + "  " + MCODE_REC[MCODE_DESCRIPTION];
                  PRINT(AT(LEFT_WINDOW, CNT + 10) + COLOR_C + FORMAT(DISPLAY_LINE, WINDOW_JUST));
               }
               MARKETING_NO = MARKETING_NO + 1;
            } while (true);
            /*  Don't prompt for course no. if this is the initial call to display a */
            /*  'blank' window */
            if (MARKETING_LIST != "") { L1000(); } else { BLANK_DISPLAY_COMPLETE = TRUE; }
