...
namespace Compiler
{
   public class FL876 : UvBase
   {
      ...
      UvVar nrf1 = "";
      #endregion
      public FL876(ref UvVar CONCESSION, ref UvVar INTERACT, ref UvVar REDISPLAY)
      {
         ...
         #endregion
         /*     COURSE TYPE CODE LIST / SELECTION SCREEN */
         PROGRAM = "FL876";
         ...
         INSTRUCTION = "SSELECT FL.CONCESS.ROLLDOWN";
         nrf0 = "SO";
      ...
      void L3000()
      {
         ...
         do
         {
            ...
            {
               CNT = CNT + 1;
               CONCESSION = TYPE_LIST[1, TYPE_NO];
               ...
               {
                  if (!MATREAD(ref ROLL_REC, FL_CONCESS_ROLLDOWN, CONCESSION)) { MAT(ref ROLL_REC, ""); }
                  DISPLAY_LINE = FORMAT(TYPE_NO, "R#4") + "  " + FORMAT(CONCESSION, "L#7") + "  " + ROLL_REC[1];
            ...
            /*  'blank' window */
            if (TYPE_LIST != "") { L1000(); } else { BLANK_DISPLAY_COMPLETE = TRUE; }
