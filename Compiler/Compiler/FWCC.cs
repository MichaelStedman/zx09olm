...
UvVar WINDOWFORM = "";
#endregion
public FWCC(ref UvVar OBJECT_NAME, ref UvVar OBJECT_TYPE, ref UvVar PARENT, ref UvVar INTLEFT, ref UvVar INTTOP, ref UvVar INTWIDTH, ref UvVar INTHEIGHT) {
...
//PRINT CC:OBJECT.NAME:",":OBJECT.TYPE:",":PARENT:EOC:
//PRINT SPC:OBJECT.NAME:",":pnLeft:",":INTLEFT:EOC:
//PRINT SPC:OBJECT.NAME:",":pnTop:",":INTTOP:EOC:
//PRINT SPC:OBJECT.NAME:",":pnWidth:",":INTWIDTH:EOC:
//PRINT SPC:OBJECT.NAME:",":pnHeight:",":INTHEIGHT:EOC:
PRINT(CC + OBJECT_NAME + "," + OBJECT_TYPE + "," + PARENT + "," + INTLEFT + "," + INTTOP + "," + INTWIDTH + "," + INTHEIGHT + EOC);
return;
}
}
}
