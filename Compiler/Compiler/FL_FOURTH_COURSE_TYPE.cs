...
namespace Compiler
{
public class FL_FOURTH_COURSE_TYPE : UvBase
{
...
UvVar MSTR_ID = "";
#endregion
public FL_FOURTH_COURSE_TYPE(ref UvVar KEY, ref UvVar CONTENT, ref UvVar TEMPLATE, ref UvVar TEMPLATE_FIELD_NO) {
this.KEY = KEY;
...
#endregion
// Return the type of a students most recent course to the data
// transfer process
...
if (!READV(ref CONTENT, FL_COURSE_MASTER, MSTR_ID, 12)) { CONTENT = ""; }
return;
}
}
}
