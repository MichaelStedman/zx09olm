...
UvVar nrf1 = "";
#endregion
public FL722(ref UvVar CENTRE_ID, ref UvVar INTERACT, ref UvVar REDISPLAY) {
...
INSTRUCTION = "SSELECT FL.MASTER.CENTRES BY 1";
nrf0 = "SO";
...
if (!MATREAD(ref MASTER_CENTRE_REC, FL_MASTER_CENTRES, CENTRE_ID)) { MAT(ref MASTER_CENTRE_REC, ""); }
DISPLAY_LINE = FORMAT(CENTRE_NO, "R#4") + "  " + FORMAT(CENTRE_ID, "L#4") + "  " + MASTER_CENTRE_REC[MC_NAME];
