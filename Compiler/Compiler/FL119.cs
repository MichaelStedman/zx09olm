...
if (!(READ(ref VALID_TYPES, COMMON.FILES[FL_TICKET_CONTROL], "VALID.LAYOUT.TYPES"))) {
VALID_TYPES[1] = "C";
...
WNDO_REC[7] = "END" + VM + "DEL" + VM + "D" + VM + "I";
}
...
void L5100() {
/*  Blat It */
DELETE(COMMON.FILES[FL_TICKET_CONTROL], TICKET_TYPE_ID);
FINISHED = TRUE;
return;
}
}
