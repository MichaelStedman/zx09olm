...
namespace Compiler
{
   public class FL864 : UvBase
   {
      ...
      UvVar nrf1 = "";
      #endregion
      public FL864(ref UvVar COURSE_TYPE, ref UvVar INTERACT, ref UvVar REDISPLAY)
      {
         ...
         INSTRUCTION = "SSELECT FL.COURSE.TYPES BY 1";
         nrf0 = "SO";
      ...
      void L3000()
      {
         ...
         do
         {
            ...
            {
               CNT = CNT + 1;
               COURSE_TYPE = TYPE_LIST[1, TYPE_NO];
               ...
               {
                  if (!MATREAD(ref CTYPE_REC, FL_COURSE_TYPES, COURSE_TYPE)) { MAT(ref CTYPE_REC, ""); }
                  DISPLAY_LINE = FORMAT(TYPE_NO, "R#4") + "  " + FORMAT(COURSE_TYPE, "L#7") + "  " + CTYPE_REC[CTYPE_DESCRIPTION];
