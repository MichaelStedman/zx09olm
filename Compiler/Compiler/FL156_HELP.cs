...
namespace Compiler
{
public class FL156_HELP : UvBase
{
...
UvVar nrf1 = "";
#endregion
public FL156_HELP(ref UvVar USER_ID, ref UvVar INTERACT, ref UvVar REDISPLAY, ref UvVar SPARE1) {
...
CODES_FOUND = FALSE;
INSTRUCTION = "SSELECT FL.PASSWORDS";
nrf0 = "SO";
...
if (!MATREAD(ref PASS_REC, COMMON.FILES[FL_PASSWORDS], USER_ID)) { MAT(ref PASS_REC, ""); }
DISPLAY_LINE = FORMAT(USER_NO, "R#4") + "  " + FORMAT(USER_ID, "L#7") + "  " + PASS_REC[PASS_NAME];
...
/*  'blank' window */
if (USER_LIST != "") { L1000(); } else { BLANK_DISPLAY_COMPLETE = TRUE; }
