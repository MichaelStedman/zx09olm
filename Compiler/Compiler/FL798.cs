...
UvVar nrf1 = "";
#endregion
public FL798(ref UvVar[] TRANS_REC, ref UvVar FILE_TYPE) {
...
PROGRAM = "FL798";
OK_TO_PROCEED = TRUE;
if (!(READV(ref EXPLORER_VERB, COMMON.FILES[FL_CONTROL], "EXPLORER.VERB*" + PORT_NUMBER, 1))) {
if (!(READV(ref EXPLORER_VERB, COMMON.FILES[FL_CONTROL], "EXPLORER.VERB", 1))) {
EXPLORER_VERB = "IEXPLORE";
}
}
if (TRANS_REC[TRANS_DOCUMENT] != "") {
if (TRANS_REC[TRANS_DOCUMENT].Substring(1, 1) != "\\") {
if (READV(ref DOC_DIRECTORY, COMMON.FILES[FL_CONTROL], "EXPLORER.DOC.DIR", 1)) {
...
if (READV(ref DAT_DIRECTORY, COMMON.FILES[FL_CONTROL], "EXPLORER.DOC.DIR", 2)) {
...
if (OK_TO_PROCEED) {
/*  CALL EXPORT ROUTINE */
/*         APPCOM = MAIN.DOCUMENT.PATH:" /M":TRANS.MACRO */
APPCOM = MAIN_DOCUMENT_PATH;
PRINTCR(CHAR(28) + "4,EXPLORER," + APPCOM + CHAR(20));
}
return;
}
}
