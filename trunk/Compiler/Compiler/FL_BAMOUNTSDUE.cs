...
namespace Compiler
{
public class FL_BAMOUNTSDUE : UvBase
{
...
UvVar AMOUNT = "";
#endregion
public FL_BAMOUNTSDUE(ref UvVar DICTVAR, ref UvVar KEY) {
...
NO_OF_AMOUNTS = DCOUNT(BLOCK_PAY_REC[BLOCK_PAY_OWES][1], VM);
for(AMOUNT = 1; AMOUNT <= NO_OF_AMOUNTS; AMOUNT += 1) {
DICTVAR[AMOUNT] = BLOCK_PAY_REC[BLOCK_PAY_OWES][1, AMOUNT];
}
return;
}
}
