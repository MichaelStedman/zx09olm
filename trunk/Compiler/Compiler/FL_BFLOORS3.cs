...
namespace Compiler
{
public class FL_BFLOORS3 : UvBase
{
...
UvVar FDESC = "";
#endregion
public FL_BFLOORS3(ref UvVar DICTVAR, ref UvVar KEY) {
...
NO_OF_FLOORS = DCOUNT(BLOCK_REC[BLOCK_FLOORS3][1], VM);
for(FLR = 1; FLR <= NO_OF_FLOORS; FLR += 1) {
FLR_CODE = BLOCK_REC[BLOCK_FLOORS3][1, FLR];
