...
namespace Compiler
{
   public class FL_BNAME : UvBase
   {
      ...
      UvVar CST_REC = "";
      #endregion
      public FL_BNAME(ref UvVar DICTVAR, ref UvVar KEY)
      {
         ...
         if (CST_REC[3] != "") { DICTVAR[1] = CST_REC[3] + " "; }
         if (CST_REC[2] != "") { DICTVAR[1] = DICTVAR[1] + CST_REC[2] + " "; }
         DICTVAR[1] = DICTVAR[1] + CST_REC[1];
         return;
      }
   }
}
