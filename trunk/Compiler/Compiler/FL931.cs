...
UvVar nrf1 = "";
#endregion
public FL931(ref UvVar RECORD_ID, ref UvVar INTERACT, ref UvVar REDISPLAY, ref UvVar SPARE1) {
...
#endregion
/*     BOOK AHEAD CONTROL SELECTION SCREEN */
PROGRAM = "FL931";
...
FOOTER = " Select Item No. or <Return> to scroll ";
RECORD_LIST = "";
/*  Box heading */
...
CODES_FOUND = FALSE;
INSTRUCTION = "SSELECT FL.CONTROL = \"BOOK.AHEAD*]\"";
nrf0 = "SO";
...
do {
CNT = CNT + 1;
RECORD_ID = RECORD_LIST[1, ITEM_NO];
...
if (!MATREAD(ref CONTROLS_REC, COMMON.FILES[FL_CONTROL], RECORD_ID)) { MAT(ref CONTROLS_REC, ""); }
DISPLAY_LINE = FORMAT(ITEM_NO, "R#4") + "  " + FORMAT(FIELD(RECORD_ID, "*", 2), "L#20");
...
/*  'blank' window */
if (RECORD_LIST != "") { L1000(); } else { BLANK_DISPLAY_COMPLETE = TRUE; }
