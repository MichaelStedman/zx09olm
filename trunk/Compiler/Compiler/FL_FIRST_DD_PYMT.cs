...
namespace Compiler
{
public class FL_FIRST_DD_PYMT : UvBase
{
...
UvVar ADJUSTMENTS = "";
#endregion
public FL_FIRST_DD_PYMT(ref UvVar KEY, ref UvVar CONTENT, ref UvVar TEMPLATE, ref UvVar TEMPLATE_FIELD_NO) {
this.KEY = KEY;
...
#endregion
// Return first valid DD PAYMENT which has not been adjusted 
// down to zero
