...
UvVar nrf1 = "";
#endregion
public FL721(ref UvVar ACTIVITY_ID, ref UvVar INTERACT, ref UvVar REDISPLAY, ref UvVar TYPE_FILTER) {
...
#endregion
/*     ACTIVITY CODE LIST / SELECTION SCREEN */
PROGRAM = "FL721";
...
FOOTER = " Select Activity No. or <Return> to scroll ";
ACTIVITY_LIST = "";
/*  Box heading */
...
if (TYPE_FILTER != "") {
/*  DJA 26.1.05 */
/* !*       INSTRUCTION = 'SSELECT FL.ACTIVITY.CODES WITH 2 = "':TYPE.FILTER:'" BY 1' */
INSTRUCTION = "SSELECT FL.ACTIVITY.CODES WITH 2 = \"\" OR WITH 2 = \"" + TYPE_FILTER + "\" BY 1";
} else {
INSTRUCTION = "SSELECT FL.ACTIVITY.CODES BY 1";
}
nrf0 = "SO";
...
if (!MATREAD(ref ACT_CODE_REC, FL_ACTIVITY_CODES, ACTIVITY_ID)) { MAT(ref ACT_CODE_REC, ""); }
DISPLAY_LINE = FORMAT(ACTIVITY_NO, "R#4") + "  " + FORMAT(ACTIVITY_ID, "L#7") + "  " + ACT_CODE_REC[ACT_CODE_DESCRIPTION];
