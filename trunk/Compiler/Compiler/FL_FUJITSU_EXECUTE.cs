...
namespace Compiler
{
public class FL_FUJITSU_EXECUTE : UvBase
{
...
UvVar ID = "";
#endregion
public FL_FUJITSU_EXECUTE(ref UvVar STATEMENT, ref UvVar OPTIONS, ref UvVar RTN_LIST, ref UvVar LIST_AVAILABLE, ref UvVar MESSAGE, ref UvVar ERRORS) {
...
#endregion
// EXECUTE FOR FUJITSU MACHINES
PROMPT("");
//***************************************************
//    INCLUDE STANDARD CODE FOR F_.FUJITSU.EXECUTE  *
//***************************************************
#region INCLUDE FZ.LIBRARY FZ.FUJITSU.EXECUTE
//    INCLUDE FZ.FUJISTU.EXECUTE

//    STANDARD INCLUDE CODE FOR FUJITSU EXECUTE STATEMENT
//******************************
