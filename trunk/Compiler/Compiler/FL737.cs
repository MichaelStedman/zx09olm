...
#endregion
/*     MAINTAIN BOOKING LEVEL NARRATIVES */
PROMPT("");
PROGRAM = "FL737";
SCREEN_CODE = PROGRAM;
...
AMENDING = FALSE;
MAIN_KEY = INIT;
MAIN_KEY = "COURSE.BOOKING.LEVELS";
...
/*  Delete compiled screen for Course Maintenance */
/* !*        INSTRUCTION = 'SELECT FL.SCREENS = "$FL700*]" OR = "$FL706*]"' */
/* !*        CALL @PROCESS.EXECUTE(INSTRUCTION,"SO",RTN.LIST,LIST.AVAILABLE,MESSAGE,ERRORS) */
/* !*        EOF = FALSE */
/* !*        LOOP */
/* !*          READNEXT ID FROM RTN.LIST ELSE EOF = TRUE */
/* !*          UNTIL EOF DO */
/* !*          DELETE FL.SCREENS, ID */
/* !*        REPEAT */
}
}
if (INTERACT == EXIT || INTERACT == FINISH) break;
