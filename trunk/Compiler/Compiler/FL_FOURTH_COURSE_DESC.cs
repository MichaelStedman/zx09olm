...
namespace Compiler
{
public class FL_FOURTH_COURSE_DESC : UvBase
{
...
UvVar MSTR_ID = "";
#endregion
public FL_FOURTH_COURSE_DESC(ref UvVar KEY, ref UvVar CONTENT, ref UvVar TEMPLATE, ref UvVar TEMPLATE_FIELD_NO) {
this.KEY = KEY;
...
#endregion
// Return the description for a students third but last course to the data
// transfer process
...
if (LAST_MV > 3) {
MSTR_ID = FIELD(CONTENT[1, LAST_MV - 3], "*", 2);
if (!READV(ref CONTENT, FL_COURSE_MASTER, MSTR_ID, 1)) { CONTENT = ""; }
} else {
CONTENT = "";
}
return;
