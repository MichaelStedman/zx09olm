...
namespace Compiler
{
public class FL_BDATES2 : UvBase
{
...
UvVar DT = "";
#endregion
public FL_BDATES2(ref UvVar DICTVAR, ref UvVar KEY) {
...
NO_OF_DATES = DCOUNT(BLOCK_REC[BLOCK_DATES2][1], VM);
for(DT = 1; DT <= NO_OF_DATES; DT += 1) {
DICTVAR[DT] = BLOCK_REC[BLOCK_DATES2][1, DT];
}
return;
}
}
