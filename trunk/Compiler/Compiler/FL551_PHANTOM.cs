...
namespace Compiler
{
   public class FL551_PHANTOM : UvBase
   {
      ...
      UvVar nrf1 = "";
      #endregion
      public FL551_PHANTOM(ref UvVar TRANSFER_FILE_NAME, ref UvVar TRANSFER_PARAM_NAME, ref UvVar TRANSFER_DIRECTORY, ref UvVar TRANSFER_OUTFILE, ref UvVar TRANSLIST, ref UvVar LIST_AVAILABLE, ref UvVar SUCCESSFUL)
      {
