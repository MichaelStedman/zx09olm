...
namespace Compiler
{
public class FWDRAWLINE : UvBase
{
...
UvVar WINDOWFORM = "";
#endregion
public FWDRAWLINE(ref UvVar INTLEFT, ref UvVar INTTOP, ref UvVar INTRIGHT, ref UvVar INTBOTTOM) {
this.INTLEFT = INTLEFT;
this.INTTOP = INTTOP;
this.INTRIGHT = INTRIGHT;
this.INTBOTTOM = INTBOTTOM;
...
PRINT(DRAWLINE + INTLEFT + "," + INTTOP + "," + INTRIGHT + "," + INTBOTTOM + EOC);
return;
}
}
}
