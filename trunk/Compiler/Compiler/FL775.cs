...
UvVar nrf1 = "";
#endregion
public FL775(ref UvVar[] TRANS_REC, ref UvVar FILE_TYPE) {
...
if (READV(ref DOC_DIRECTORY, COMMON.FILES[FL_CONTROL], "EXCEL.DOC.DIR", 1)) {
...
if (READV(ref DAT_DIRECTORY, COMMON.FILES[FL_CONTROL], "EXCEL.DOC.DIR", 2)) {
...
PRINTCR(CHAR(28) + "4,EXCEL," + APPCOM + CHAR(20));
}
return;
}
}
