...
UvVar WINDOWFORM = "";
#endregion
public FWSP(ref UvVar OBJECT_NAME, ref UvVar PROPERTY, ref UvVar VALUE) {
...
#endregion
//    Set the value of a controls property
PRINT(SPC + OBJECT_NAME + "," + PROPERTY + "," + VALUE + EOC);
return;
}
}
}
