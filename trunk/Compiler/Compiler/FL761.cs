...
#endregion
/*     MAINTAIN GENERAL COURSE PARAMETERS */
PROMPT("");
PROGRAM = "FL761";
SCREEN_CODE = PROGRAM;
...
void L1000() {
/*  Routine to generate new student id's */
INTERACT = VALID_DATA;
return;
}
void L1100() {
/*  MANUAL RECEIPTS PERMITTED? */
if (ANS == "" || ANS == "Y" || ANS == "N") {
INTERACT = VALID_DATA;
} else {
nrf0 = 5;
...
void L1200() {
/*  Privilege level needed to amend course fees */
INTERACT = VALID_DATA;
// BEGIN CASE
// CASE
if (ANS == "") {
...
void L1300() {
/*  First instalment is the odd one */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 3;
...
void L1400() {
/*  Course comments printed on ticket */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 4;
...
void L1500() {
/*  Automatic fee adjustments in Payments */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 5;
...
void L1600() {
/*  Allow concess & member change in Payments */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 6;
...
void L1700() {
/*  Print underscores on attendance register */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 3;
...
void L1800() {
/*  Print phone numbers on attendance register */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 3;
...
void L2000() {
/*  Routine to prompt for card number when new student created */
INTERACT = VALID_DATA;
return;
}
void L2100() {
/*  Routine to format card number when new student created */
INTERACT = VALID_DATA;
return;
}
void L2200() {
/*  Double space attendance register */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 6;
...
void L2300() {
/*  Hide closed courses in Enrolments */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 6;
...
void L2400() {
/*  Prevent instalments and part-payments */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 6;
...
void L2500() {
/*  Course scanning sort criteria */
INTERACT = VALID_DATA;
return;
}
void L2600() {
/*  Automatically deduce concessions in activity day enrolment */
if (ANS == "Y" || ANS == "N" || ANS == "") {
INTERACT = VALID_DATA;
} else {
nrf0 = 10;
