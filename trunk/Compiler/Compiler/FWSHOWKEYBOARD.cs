...
namespace Compiler
{
public class FWSHOWKEYBOARD : UvBase
{
...
UvVar MESSAGE = "";
#endregion
public FWSHOWKEYBOARD(ref UvVar PROMPT_TEXT, ref UvVar START_TEXT, ref UvVar VALUE, ref UvVar PASSWORD_FLAG, ref UvVar RESULT) {
...
ECHO_OFF();
if (PASSWORD_FLAG) {
PRINT(SHOWKEYBOARD + PROMPT_TEXT + "," + START_TEXT + ",*" + CHAR(20));
} else {
PRINT(SHOWKEYBOARD + PROMPT_TEXT + "," + START_TEXT + "," + CHAR(0) + CHAR(20));
}
do {
INPUT(out MESSAGE);
if (INDEX(MESSAGE[1, 1], "keyboard", 1)) break;
