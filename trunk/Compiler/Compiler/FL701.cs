...
#endregion
/*     CONTROLLING ROUTINE FOR COURSE MAINTENANCE */
PROMPT("");
PROGRAM = "FL701";
SCREEN_CODE = PROGRAM;
INTERACT = "";
...
// CASE
if (PAGE_NO == 1) {
FL700 = new FL700(ref COURSE_MSTR_REC, ref COURSE_DET_REC, ref NEW_COURSE, ref OLD_COURSE_DATE);
}// CASE
else if (PAGE_NO == 2) {
/*  Course restrictions */
FL702 = new FL702(ref COURSE_MSTR_REC, ref COURSE_DET_REC, ref NEW_COURSE);
}// CASE
else if (PAGE_NO == 3) {
/*  Statistics */
FL703 = new FL703(ref COURSE_MSTR_REC, ref COURSE_DET_REC, ref NEW_COURSE);
}// CASE
else if (OTHERWISE) {
nrf0 = 1;
nrf1 = INIT;
