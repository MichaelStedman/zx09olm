...
namespace Compiler
{
public class FL_FIRST_DD_DATE : UvBase
{
...
UvVar DATES = "";
#endregion
public FL_FIRST_DD_DATE(ref UvVar KEY, ref UvVar CONTENT, ref UvVar TEMPLATE, ref UvVar TEMPLATE_FIELD_NO) {
this.KEY = KEY;
