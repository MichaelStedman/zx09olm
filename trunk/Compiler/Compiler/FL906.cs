...
#endregion
/*     MAINTAIN BOLTON MAG. CARD PRINT POSITIONS, FONTS ETC */
PROMPT("");
PROGRAM = "FL906";
SCREEN_CODE = PROGRAM;
...
L8000();
/*  LOAD TEMP.REC */
if (READ(ref TEST_REC, COMMON.FILES[FL_CONTROL], "BOLTON.CARD.PARAMS")) {
AMENDING = TRUE;
L0300();
} else {
...
/*  LOAD TEMP.REC                     * */
/* **************************************** */
if (!READ(ref BOLTON_CARD_PARAMS, COMMON.FILES[FL_CONTROL], "BOLTON.CARD.PARAMS")) { BOLTON_CARD_PARAMS = ""; }
TEMP_REC[1] = BOLTON_CARD_PARAMS[1, 1];
TEMP_REC[2] = BOLTON_CARD_PARAMS[2, 1];
TEMP_REC[3] = BOLTON_CARD_PARAMS[3, 1];
TEMP_REC[4] = BOLTON_CARD_PARAMS[4, 1];
TEMP_REC[5] = BOLTON_CARD_PARAMS[5, 1];
TEMP_REC[6] = BOLTON_CARD_PARAMS[6, 1];
TEMP_REC[7] = BOLTON_CARD_PARAMS[7, 1];
TEMP_REC[8] = BOLTON_CARD_PARAMS[8, 1];
TEMP_REC[9] = BOLTON_CARD_PARAMS[9, 1];
TEMP_REC[10] = BOLTON_CARD_PARAMS[10, 1];
TEMP_REC[11] = BOLTON_CARD_PARAMS[11, 1];
TEMP_REC[12] = BOLTON_CARD_PARAMS[12, 1];
TEMP_REC[13] = BOLTON_CARD_PARAMS[13, 1];
TEMP_REC[14] = BOLTON_CARD_PARAMS[14, 1];
TEMP_REC[15] = BOLTON_CARD_PARAMS[15, 1];
TEMP_REC[16] = BOLTON_CARD_PARAMS[16, 1];
TEMP_REC[17] = BOLTON_CARD_PARAMS[17, 1];
return;
/* **************************************** */
}
void L9000() {
/*  UNLOAD TEMP.REC AND WRITE DATA    * */
/* **************************************** */
BOLTON_CARD_PARAMS[1, 1] = TEMP_REC[1];
BOLTON_CARD_PARAMS[2, 1] = TEMP_REC[2];
BOLTON_CARD_PARAMS[3, 1] = TEMP_REC[3];
BOLTON_CARD_PARAMS[4, 1] = TEMP_REC[4];
BOLTON_CARD_PARAMS[5, 1] = TEMP_REC[5];
BOLTON_CARD_PARAMS[6, 1] = TEMP_REC[6];
BOLTON_CARD_PARAMS[7, 1] = TEMP_REC[7];
BOLTON_CARD_PARAMS[8, 1] = TEMP_REC[8];
BOLTON_CARD_PARAMS[9, 1] = TEMP_REC[9];
BOLTON_CARD_PARAMS[10, 1] = TEMP_REC[10];
BOLTON_CARD_PARAMS[11, 1] = TEMP_REC[11];
BOLTON_CARD_PARAMS[12, 1] = TEMP_REC[12];
BOLTON_CARD_PARAMS[13, 1] = TEMP_REC[13];
BOLTON_CARD_PARAMS[14, 1] = TEMP_REC[14];
BOLTON_CARD_PARAMS[15, 1] = TEMP_REC[15];
BOLTON_CARD_PARAMS[16, 1] = TEMP_REC[16];
BOLTON_CARD_PARAMS[17, 1] = TEMP_REC[17];
WRITE(BOLTON_CARD_PARAMS, COMMON.FILES[FL_CONTROL], "BOLTON.CARD.PARAMS");
return;
/* ****************** */
/*   End of Program * */
/* ****************** */
