...
UvVar LN = "";
#endregion
public FL_BNOTES(ref UvVar DICTVAR, ref UvVar KEY) {
...
NO_OF_LINES = DCOUNT(BLOCK_REC[BLOCK_NOTES][1], VM);
for(LN = 1; LN <= NO_OF_LINES; LN += 1) {
DICTVAR[LN] = BLOCK_REC[BLOCK_NOTES][1, LN];
}
return;
}
}
