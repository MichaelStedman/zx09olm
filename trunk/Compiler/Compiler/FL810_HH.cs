...
UvVar nrf3 = "";
#endregion
public FL810_HH(ref UvVar TILL_KEY, ref UvVar FIRST_DATE, ref UvVar PRINT_TYPE) {
this.TILL_KEY = TILL_KEY;
...
/*  prompt for dates */
/*     PRINT @(20,16):"Please Wait, Producing Report": */
...
TOTAL_REC[5, -1] = USER_REC[MOP, 1];
TOTAL_REC[6, -1] = USER_REC[MOP, 2];
TOTAL_REC[7, -1] = USER_REC[MOP, 3];
}
}
}
PRINT_REC[-1] = " ";
